...
|---|---|---|
|001_data_partitioning_v1.ipynb|1. 將原始資料依照TSE產業別區分為金融業與非金融業<br/>2. 找出需要補值的缺失值|* Pivot Table (樞紐分析表)[link](https://www.learncodewithmike.com/2022/02/pandas-pivot-table.html)<br/>[Counting Continuous NaN Values for Pandas Time Series](https://stackoverflow.com/questions/52561874/counting-continuous-nan-values-in-panda-time-series)|
