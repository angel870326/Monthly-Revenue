...
|2023/05/06|015_industry_v1|Four methods for constructing industry variables. (CountEncoder)|<ul><li>Frequency and Target Encoding ([link1](https://axk51013.medium.com/%E4%B8%8D%E8%A6%81%E5%86%8D%E5%81%9Aone-hot-encoding-b5126d3f8a63)) ([link2](https://towardsdatascience.com/feature-encoding-techniques-in-machine-learning-with-python-implementation-dbf933e64aa))</li></ul>|
...
|2023/06/11|024_randomforest_xgb_search_t_1_v1|Monthly revenue forecasting results from 2018/1 to 2022/12 with Random Forest Regressor & XGB Regressor, including predicting results, scores and feature importance.<br><ul><li>**Online search volume: t-1.**</li><li>Model related: **MonRevForecast.ipynb**</il><li>Plot related: **MonRevPlot.ipynb**<il></ul>|<ul><li>RandomForestRegressor ([link](https://scikit-learn.org/stable/modules/generated/sklearn.ensemble.RandomForestRegressor.html))</li><li>XGBRegressor ([link](https://xgboost.readthedocs.io/en/stable/python/python_api.html#xgboost.XGBRegressor))</li></ul>|
|2023/06/12|**025_rnn_lstm_search_mean_v3**|Monthly revenue forecasting results from 2018/1 to 2022/12 with RNN & LSTM (loss = 'mse'), including predicting results and scores.<br><ul><li>**Online search volume: Mean of t-4 to t-1.**</li><li>Model related: **MonRevForecast.ipynb**</il><li>Plot related: **MonRevPlot.ipynb**<il></ul>|<ul><li>SimpleRNN layer ([link](https://keras.io/api/layers/recurrent_layers/simple_rnn/))</li><li>LSTM layer ([link](https://keras.io/api/layers/recurrent_layers/lstm/))</li></ul>|
|2023/06/12|026_rnn_lstm_search_t-1_v1|Monthly revenue forecasting results from 2018/1 to 2022/12 with RNN & LSTM (loss = 'mse'), including predicting results and scores.<br><ul><li>**Online search volume: t-1.**</li><li>Model related: **MonRevForecast.ipynb**</il><li>Plot related: **MonRevPlot.ipynb**<il></ul>|<ul><li>SimpleRNN layer ([link](https://keras.io/api/layers/recurrent_layers/simple_rnn/))</li><li>LSTM layer ([link](https://keras.io/api/layers/recurrent_layers/lstm/))</li></ul>|  
...
|2023/06/14|**029_compare_results_v1**|Compare the forecasting results of Benchmark, Random Forest, XGB, RNN, LSTM & DNN with and without incorporating internet search volume from 2018/1 to 2022/12.|<ul><li>Order matplotlib legend ([link](https://stackoverflow.com/questions/10101141/matplotlib-legend-add-items-across-columns-instead-of-down))</li></ul>|
...
<table>
  ...
  <tr>
    ...
    <td>
      ...
      2023/06/18 - Add scaler for search volume feature in <I>4.6 Search Volume Data</I> & <I>5. Model Training</I> & <I>6. Predicting and Evaluation</I>.<br>
    </td>
    <td>
      <ul>
